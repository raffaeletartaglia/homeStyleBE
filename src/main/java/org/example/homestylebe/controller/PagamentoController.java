...
public class PagamentoController {
         ...
         *
         * @param requestDTO Il DTO contenente i dettagli della richiesta di pagamento
         *                   (es. importo, metodo).
        ...
        /**
         * Recupera le informazioni dettagliate di un singolo pagamento tramite il suo
         * ID.
         *
         ...
         * Tipicamente chiamato se un utente annulla l'ordine prima della transazione
         * effettiva.
         *
         ...
         * della transazione (es. in COMPLETATO) previa validazione della disponibilità
         * fondi (simulata).
         *
